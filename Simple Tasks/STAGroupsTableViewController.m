...
//        groups = ([@[] mutableCopy]) ? [self loadGroupData] : [@[] mutableCopy];
...
-(void)addNewGroupClicked
{
    ...
    // subclass UIViewController ... named "STANewGroupViewController"
    
    // add textfield for group name
    
    // add 2 buttons for cancel and save
    
    // *property* pass the groups array to the "STANewGroupViewController"
    
    // save creates NSMutableDictionary and adds it to the groups array
    
    // save & cancel "dismiss" the "STANewGroupViewController"
...
//    [groupData writeToFile:groupData options:NSDataWritingAtomic error:nil];
