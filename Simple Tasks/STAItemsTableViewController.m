...
-(void)addNewItemClicked
    {
        STANewEditItemViewController *addNewItemVC = [[STANewEditItemViewController alloc] init];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete)
    {
        ...
        [self.groupInfo[@"items"] removeObjectAtIndex:indexPath.row];
...
//        
//        return [path stringByAppendingString:@"item.data"];
//    }
